...
//}
    ...
    @PostMapping("/forgot_password")
    public ResponseEntity<?> processForgotPassword(HttpServletRequest request,@Valid @RequestBody ForgotRequest forgotRequest) {
...
//        String resetPasswordLink = Utility.getSiteURL(request) + "/api/auth/reset_password?token=" + token;
      String resetPasswordLink = Utility.getSiteURL(request) + "/reset?token=" + token;
        ...
        return ResponseEntity
				.ok()
				.body(new MessageResponse("Sent Email"));
...
//    }
    @PostMapping("/reset_password")
    public ResponseEntity<?> processForgotPassword(@Valid @RequestBody ResetRequest requestRequest,HttpServletRequest request ) {
    	 String token = request.getParameter("token");
       ...
       if (customer == null) {
        ...
        return ResponseEntity
   				.ok()
   				.body(new MessageResponse("You have successfully changed your password."));
